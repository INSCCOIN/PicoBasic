...
' Build changes: Changed what the menu & progress bar look like. 
...
DO
    ...
    IF mainopt = 2 THEN
        DO
            ...
            PRINT "  1. Trig         2. Exp/Log"
            PRINT "  3. Sqrt/Pow     4. Mixed"
            PRINT "  5. Integer      6. Random"
            PRINT "  7. Factorial    8. Sort"
            PRINT "  9. String      10. Matrix"
            PRINT " 11. Fibonacci   12. Prime"
            PRINT " 13. ArraySum    14. Bitwise"
            PRINT " 15. Harmonic    16. Geometric"
            PRINT " 17. LogSeries   18. PolyEval"
            PRINT " 19. GCD         20. LCM"
            PRINT " 21. Ackermann   22. Collatz"
            PRINT " 23. Pascal Row  24. Catalan"
    ...
    ELSEIF mainopt = 1 THEN
        ...
        t1 = TIMER
        FOR i = 1 TO steps
            IF i MOD (steps \ barlen) = 0 OR i = steps THEN
                prog = INT(i / steps * barlen)
                bar$ = STRING$(prog, "=")
                IF prog < barlen THEN bar$ = bar$ + ">" + STRING$(barlen - prog - 1, " ") ELSE bar$ = bar$ + " "
                pct = INT(i / steps * 100)
                PRINT CHR$(13); "Progress: ["; bar$; "] "; RIGHT$("  " + STR$(pct), 3); "%"; CHR$(13);
            ENDIF
